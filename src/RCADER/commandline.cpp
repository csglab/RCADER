...
static s_command_parameter _command_parameters[] = {
	...
	{	"Input file containing the sequence scores (to be modeled by the motifs)",
		"-score", _TYPE_STRING, true, false, 0, 0.0, "None" },
	...
	{	"Score transformation mode (1: log-scale; 2: linear)",
		"-mode", _TYPE_INT, true, true, 1, 0.0, "None" },
	{	"Correct for nucleotide/dinucleotide composition (0: false; 1: true)",
		"-dinuc", _TYPE_INT, true, true, 1, 0.0, "None" },
	{	"The experiment name",
...
const char *__score_file = _command_parameters[ 2 ].v_string;
...
const int *__correct_dinuc = & _command_parameters[ 6 ].v_int;
const char *__experiment = _command_parameters[ 7 ].v_string;
const char *__output_file = _command_parameters[ 8 ].v_string;
